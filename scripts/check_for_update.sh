...
NPM_PRISMA_DEV_VERSION=$(sh scripts/npm_prisma_version.sh "dev")
NPM_PRISMA_LATEST_VERSION=$(sh scripts/npm_prisma_version.sh "latest")
NPM_PRISMA_PATCH_DEV_VERSION=$(sh scripts/npm_prisma_version.sh "patch-dev")
