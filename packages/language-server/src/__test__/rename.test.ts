...
import { getMaxSafeValue } from '../util'
        ...
        changes: {
          [renameFieldLargeSchema.uri]: [
            ...
            },
            {
              newText: ' @map("Album")',
              range: {
                start: { line: 136, character: getMaxSafeValue() },
                end: { line: 136, character: getMaxSafeValue() },
              },
            },
          ],
        },
        ...
        changes: {
          [renameField.uri]: [
            ...
            },
            {
              ...
              range: {
                start: { line: 4, character: getMaxSafeValue() },
                end: { line: 4, character: getMaxSafeValue() },
              },
            },
            {
              newText: newFieldName,
        ...
        changes: {
          [renameField.uri]: [
            ...
            },
            {
              newText: ' @map("title")',
              range: {
                start: { line: 17, character: getMaxSafeValue() },
                end: { line: 17, character: getMaxSafeValue() },
              },
            },
            {
              newText: newFieldName2,
        ...
        changes: {
          [renameField.uri]: [
            ...
            },
            {
              newText: ' @map("humanId")',
              range: {
                start: { line: 25, character: getMaxSafeValue() },
                end: { line: 25, character: getMaxSafeValue() },
              },
            },
            {
              newText: newFieldName3,
        ...
        changes: {
          [renameEnum.uri]: [
            ...
            },
            {
              ...
              range: {
                start: { line: 8, character: getMaxSafeValue() },
                end: { line: 8, character: getMaxSafeValue() },
              },
            },
            {
